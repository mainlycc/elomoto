...
export const ServicesSection: React.FC = () => {
  return (
    <section id="services" className="py-32 bg-[#0a1a14] relative overflow-hidden">
      <div className="absolute top-0 right-0 w-64 h-64 bg-[#00ff88]/5 rounded-full blur-3xl -z-10"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-20">
          <div className="max-w-xl">
            <div className="flex items-center space-x-4 mb-4">
              ...
              <p className="text-[#00ff88] font-black uppercase tracking-[0.3em] text-xs">Ecosystem</p>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {SERVICES.map((service, index) => (
            <div 
              key={index} 
              className="group relative bg-white/5 rounded-[32px] p-2 transition-all duration-500 hover:bg-white/10 hover:shadow-2xl flex flex-col h-full border border-white/5 hover:border-[#00ff88]/20"
            >
              ...
              <div className="p-8 flex flex-col flex-grow">
                ...
                <h3 className="text-lg font-black text-white mb-4 uppercase leading-tight group-hover:text-[#00ff88] transition-colors">
                  {service.title}
                </h3>
                ...
                <a 
                  href={service.link}
                  className="w-12 h-12 rounded-2xl bg-white/5 flex items-center justify-center text-[#00ff88] border border-white/10 group-hover:bg-[#00ff88] group-hover:text-black transition-all duration-300"
                >
