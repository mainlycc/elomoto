...
export const OfertaEkspertyzyPage: React.FC = () => {
  ...
  return (
    <section className={NAV_ALIGNED_PAGE_SHELL}>
      ...
      {/* Opis główny */}
      <div className={`mb-16 ${OFFER_TEXT_COLUMN}`}>
        <div className={`space-y-4 text-base text-gray-300 leading-relaxed ${OFFER_LEDE_INNER}`}>
          <p>
      ...
      <div className="mb-16">
        ...
        <div className="glass border border-white/10 rounded-3xl p-6 md:p-8 text-left">
          <p className="text-base text-gray-300 leading-relaxed mb-4 font-semibold">
      ...
      <div className="mb-16">
        ...
        <div className={`mt-6 ${OFFER_TEXT_COLUMN}`}>
      ...
      <div className="mb-16">
        <div className={`mb-6 ${OFFER_TEXT_COLUMN}`}>
          <h2 className="text-xl font-black text-white uppercase tracking-tight">
