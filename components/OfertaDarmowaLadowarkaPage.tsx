  ...
  return (
    <section className={NAV_ALIGNED_PAGE_SHELL}>
      ...
      <div className="mb-16">
        ...
        <div className={`mt-4 ${OFFER_TEXT_COLUMN}`}>
          <p className={`text-base text-gray-400 italic leading-relaxed ${OFFER_LEDE_INNER}`}>
      ...
      {/* Proces inwestycji */}
      <div className="mb-20">
        <div className={`mb-8 ${OFFER_TEXT_COLUMN}`}>
          <h2 className="text-xl font-black text-white uppercase tracking-tight">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            ...
            <div key={item.step} className="glass border border-white/10 rounded-3xl p-6 space-y-3 text-left">
