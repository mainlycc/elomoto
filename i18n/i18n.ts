...
export const translations: Translations = {
  pl: {
    ...
    cookiesBanner: {
      ...
      intro:
        'Używamy plików cookies i podobnych technologii, aby strona działała poprawnie, zapamiętywała ustawienia oraz — za Twoją zgodą — mierzyła statystyki i wspierała marketing.',
      hint: 'Możesz zaakceptować wszystkie kategorie, odrzucić opcjonalne albo dostosować wybór.',
      rejectOptional: 'Tylko niezbędne',
      customize: 'Dostosuj',
      acceptAll: 'Akceptuj wszystkie',
      policyLink: 'Polityka prywatności i cookies',
      settingsTitle: 'Ustawienia cookies',
      settingsIntro: 'Niezbędne cookies są zawsze aktywne. Pozostałe kategorie włączasz dobrowolnie.',
      ...
      categories: {
        necessary: {
          ...
          desc: 'Zapewniają podstawowe działanie strony, bezpieczeństwo i zapamiętanie wyborów, bez których serwis nie działa prawidłowo.',
        },
        functional: {
          label: 'Funkcjonalność',
          desc: 'Ułatwiają korzystanie z serwisu, np. zapamiętanie języka lub preferencji wyświetlania.',
        },
        analytics: {
          label: 'Analityka',
          desc: 'Pomagają zrozumieć, jak używana jest strona (np. statystyki odwiedzin) — dane zwykle w formie zagregowanej.',
        },
        marketing: {
          label: 'Marketing',
          desc: 'Umożliwiają dopasowanie komunikacji i pomiar skuteczności kampanii reklamowych, jeśli takie narzędzia są stosowane.',
        },
      },
    },
    nav: {
    ...
    aboutPage: {
      imageAlt: 'Elomoto — O nas',
      heroBrand: 'Elomoto',
      heroCardTitle: 'Budujemy sieć ładowania na lata',
      eyebrow: 'Opis firmy',
      pageTitle: 'O NAS',
      teamEyebrow: 'Nasz zespół',
      teamHeading: 'Poznaj osoby, które tworzą Elomoto',
      errorLoadingTeam: 'Nie udało się pobrać zespołu z CMS. Spróbuj ponownie za chwilę.',
      emptyTeam: 'Brak osób w sekcji zespołu. Dodaj członków w CMS, aby wyświetlić ich na stronie.',
    ...
    realizationsPage: {
      ...
      listLoading: 'Ładowanie realizacji…',
      listError: 'Nie udało się załadować listy realizacji.',
      empty: 'Brak opublikowanych realizacji.',
      cardTeaser:
        'Zobacz szczegóły tej realizacji – zakres prac, typ stacji oraz sposób, w jaki ładowanie wspiera codzienne funkcjonowanie obiektu.',
      contactKicker: 'Formularz kontaktowy',
      contactTitle: 'Chcesz podobną',
      contactHighlightedTitle: 'realizację?',
      contactDescription:
        'Omówmy możliwości wdrożenia infrastruktury ładowania w Twoim obiekcie. Przygotujemy indywidualną ofertę dopasowaną do Twoich potrzeb.',
      contactMessagePlaceholder: 'Opisz swój projekt, liczbę miejsc postojowych i typ obiektu...',
    },
    realizationDetail: {
      loading: 'Ładowanie realizacji…',
      errorLoadTitle: 'Nie udało się załadować realizacji',
      errorLoadBody: 'Spróbuj ponownie później lub wróć do listy.',
      backToList: 'Wróć do realizacji',
      notFoundTitle: 'Realizacja nie została znaleziona',
      notFoundBody: 'Sprawdź poprawność adresu URL lub wróć do listy wszystkich realizacji.',
      eyebrow: 'nasze projekty',
      heroTitle: 'Realizacje',
      heroTitleAccent: 'elomoto.eco',
      defaultIntro:
      ...
      defaultDetailLead:
        'Wybrane wdrożenia infrastruktury ładowania w biurowcach, hotelach, centrach handlowych i na osiedlach mieszkaniowych. Różne lokalizacje, jeden standard – wygodne, bezpieczne i nowoczesne ładowanie pojazdów elektrycznych.',
      defaultScopeTitle: 'Zakres projektu',
      defaultScopeP:
      ...
      defaultScopeLi1: '• instalacja kilku punktów ładowania AC / DC,',
      defaultScopeLi2: '• dopasowanie infrastruktury do istniejącej rozdzielni,',
      defaultScopeLi3: '• konfiguracja dostępu dla mieszkańców / klientów / pracowników,',
      defaultScopeLi4: '• integracja z usługą operatorską elomoto.eco.',
      defaultEffectsTitle: 'Efekty dla inwestora',
      defaultEffectsLead:
      ...
      defaultHighlightComfortLabel: 'komfort',
      defaultHighlightComfortText: 'Ładowanie dostępne tam, gdzie użytkownicy spędzają najwięcej czasu.',
      defaultHighlightImageLabel: 'wizerunek',
      defaultHighlightImageText: 'Wzmocnienie proekologicznego wizerunku inwestycji.',
      defaultHighlightDataLabel: 'dane',
      defaultHighlightDataText: 'Lepsze zrozumienie realnego zapotrzebowania na ładowanie dzięki raportom.',
      backToListLong: 'Wróć do listy realizacji',
      otherHeading: 'Inne',
      otherHeadingAccent: 'realizacje',
    },
    blog: {
      ...
      empty: 'Brak opublikowanych wpisów w wybranym języku.',
      corsHint:
    ...
    blogPage: {
      eyebrow: 'Blog & wiadomości',
      title: 'Wszystkie artykuły o elektromobilności',
      intro:
        'Zebraliśmy w jednym miejscu nasze artykuły, aktualności i poradniki związane z ładowaniem samochodów elektrycznych oraz rozwojem infrastruktury EV.',
      listError: 'Nie udało się załadować listy wpisów.',
    },
    blogPost: {
      errorLoad: 'Nie udało się załadować wpisu. Spróbuj ponownie później.',
      backToBlog: 'Wróć do bloga',
      notFoundTitle: 'Nie znaleziono wpisu',
      notFoundBody: 'Sprawdź adres URL lub wróć do listy artykułów.',
  ...
  en: {
    ...
    cookiesBanner: {
      ...
      intro:
        'We use cookies and similar technologies to run the site, remember your settings, and — with your consent — measure performance and support marketing.',
      hint: 'You can accept all categories, reject optional ones, or customize your choices.',
      rejectOptional: 'Essential only',
      customize: 'Customize',
      acceptAll: 'Accept all',
      policyLink: 'Privacy & cookie policy',
      settingsTitle: 'Cookie settings',
      settingsIntro: 'Essential cookies are always on. You can opt in to the other categories.',
      ...
      categories: {
        necessary: {
          ...
          desc: 'Required for core functionality, security, and remembering choices the site needs to operate properly.',
        },
        functional: {
          label: 'Functionality',
          desc: 'Help the site work better for you, for example remembering language or display preferences.',
        },
        analytics: {
          label: 'Analytics',
          desc: 'Help us understand how the site is used (e.g. aggregated visit statistics).',
        },
        marketing: {
          label: 'Marketing',
          desc: 'Support tailored messaging and measuring ad performance when such tools are used.',
        },
      },
    },
    nav: {
    ...
    aboutPage: {
      imageAlt: 'Elomoto — About us',
      heroBrand: 'Elomoto',
      heroCardTitle: 'Building a charging network for the long term',
      eyebrow: 'Company profile',
      pageTitle: 'ABOUT US',
      teamEyebrow: 'Our team',
      teamHeading: 'Meet the people behind Elomoto',
      errorLoadingTeam: 'Could not load the team from the CMS. Please try again in a moment.',
      emptyTeam: 'No team members yet. Add members in the CMS to display them here.',
      joinCta: 'Join us!',
    },
    process: {
      badge: 'Ecosystem workflow',
    ...
    realizationsPage: {
      eyebrow: 'our projects',
      title: 'elomoto.eco projects',
      intro:
        'Selected EV charging infrastructure deployments in office buildings, hotels, shopping centers, and residential developments. Different locations — one standard: convenient, safe, and modern electric vehicle charging.',
      listLoading: 'Loading projects…',
      listError: 'Could not load the project list.',
      empty: 'No published projects in this language yet.',
      cardTeaser:
        'See the full case — scope of work, station type, and how charging supports day-to-day operations at the site.',
      contactKicker: 'Contact form',
      contactTitle: 'Want a similar',
      contactHighlightedTitle: 'project?',
      contactDescription:
        'Let’s discuss deploying charging infrastructure at your property. We’ll prepare a tailored offer based on your needs.',
      contactMessagePlaceholder: 'Describe your project, number of parking spaces, and property type...',
    },
    realizationDetail: {
      loading: 'Loading project…',
      errorLoadTitle: 'Could not load this project',
      errorLoadBody: 'Please try again later or return to the list.',
      backToList: 'Back to projects',
      notFoundTitle: 'Project not found',
      notFoundBody: 'Check the URL or return to the full project list.',
      eyebrow: 'our projects',
      heroTitle: 'Projects',
      heroTitleAccent: 'elomoto.eco',
      defaultIntro:
        'A sample EV charging infrastructure deployment in a commercial property. The text below is illustrative — you can replace it with a full case study in Sanity.',
      defaultDetailLead:
      ...
      defaultScopeTitle: 'Project scope',
      defaultScopeP:
      ...
      defaultScopeLi1: '• installation of multiple AC / DC charging points,',
      defaultScopeLi2: '• infrastructure aligned with the existing switchgear,',
      defaultScopeLi3: '• access setup for residents / customers / employees,',
      defaultScopeLi4: '• integration with the elomoto.eco operator service.',
      defaultEffectsTitle: 'Benefits for the investor',
      defaultEffectsLead:
        'Charging infrastructure adds value for users and enables reporting on station usage and electricity consumption.',
      defaultHighlightComfortLabel: 'comfort',
      defaultHighlightComfortText: 'Charging where people spend most of their time.',
      defaultHighlightImageLabel: 'brand',
      defaultHighlightImageText: 'Strengthening the property’s green credentials.',
      defaultHighlightDataLabel: 'data',
      defaultHighlightDataText: 'Better insight into real charging demand through reports.',
      backToListLong: 'Back to project list',
      otherHeading: 'More',
      otherHeadingAccent: 'projects',
    },
    blog: {
      eyebrow: 'BLOG & NEWS',
    ...
    blogPage: {
      eyebrow: 'Blog & news',
      title: 'All articles on e-mobility',
      intro:
        'Articles, updates, and guides on electric vehicle charging and EV infrastructure — in one place.',
      listError: 'Could not load the post list.',
    },
    blogPost: {
      errorLoad: 'Could not load this post. Please try again later.',
      backToBlog: 'Back to blog',
      notFoundTitle: 'Post not found',
      notFoundBody: 'Check the URL or return to the article list.',
